    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "Tehran, Iran", 1, "663d5303-9ca8-4445-9a9a-f367997c6a03", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "ela@gmail.com", false, "Ela", null, 50000.0, "Sdq", false, null, "ELA@GMAIL.COM", "ELA", "AQAAAAIAAYagAAAAEPlBxCZhPVvlIVsUUrhDlLUVGVC7eglVk5Emfhb2Jum6cL9U+yH0JoCk4E6LVU7L0w==", "093689162292", false, "Guid.NewGuid().ToString()", false, "ela" },
                    { 2, 0, "Tehran, Iran", 1, "da87f6ce-94ae-47c1-8a82-8e166a67920d", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "sara@gmail.com", false, "Sara", null, 5000.0, "Sdq", false, null, "SARA@GMAIL.COM", "SARA", "AQAAAAIAAYagAAAAEHiCLa8oVbF3QqzVk0hDJ6OPFJEGQ2MrsN3GwWXGLDCDJE0xRnbTfFFbHVK7eIRRpQ==", "09124361938", false, null, false, "sara" },
                    { 3, 0, "Tehran, Iran", 1, "ecca45ab-4420-47a3-8b34-e5ce2ea2f314", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "amir@gmail.com", false, "Amir", null, 5000.0, "Sdq", false, null, "AMIR@GMAIL.COM", "AMIR", "AQAAAAIAAYagAAAAEPF5DsSYdZjYFyaY4ygmm9Dy7ZgEh7kRRAAcTwbBTj7sUG0upkDvbsTUGL04dyGq9Q==", "09016308704", false, null, false, "amir" }
                });
            ...
            migrationBuilder.InsertData(
                table: "HomeServices",
                columns: new[] { "Id", "CreatedAt", "ImagePath", "IsDeleted", "Price", "SubCategoryId", "Title", "VisitCount" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Requests",
                columns: new[] { "Id", "ApprovedAt", "CityId", "CreatedAt", "CustomerId", "Description", "HomeServiceId", "IsDeleted", "RequestForTime", "RequestStatus", "Title" },
                values: new object[,]
                {
                    { 1, null, 1, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, " تمیزکاری خانه", 1, false, new DateTime(2025, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "نظافت" },
                    { 2, null, 1, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "سلامت و زیبایی ", 1, false, new DateTime(2025, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "زیبایی بانوان" }
                });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "Comment", "CreatedAt", "CustomerId", "ExpertId", "IsAccept", "IsDeleted", "Rating" },
                values: new object[] { 1, "از این کار راضی بودم", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, false, false, 4 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "من این خانه را به خوبی نظافت می کنم", 1, false, new DateTime(2025, 2, 17, 13, 15, 19, 785, DateTimeKind.Local).AddTicks(5112), 4, 1, 500000 },
                    { 2, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "پیشنهاد برای تعمیر کولر", 1, false, new DateTime(2025, 2, 16, 13, 15, 19, 785, DateTimeKind.Local).AddTicks(5122), 1, 2, 750000 }
                });
